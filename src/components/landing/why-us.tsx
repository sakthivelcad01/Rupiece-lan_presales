      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          {features.map((feature) => (
            <Card key={feature.title} className="flex flex-col items-center text-center p-6 bg-card hover:bg-background transition-colors duration-300 transform hover:-translate-y-1 shadow-sm hover:shadow-lg">
